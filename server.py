...
class MemoryOSHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def handle_sports(self):
        ...
        cn_alias = {
            ...
            '巴萨': 'FC Barcelona', '拜仁': 'Bayern Munich', '拜仁慕尼黑': 'Bayern Munich',
            '多特': 'Borussia Dortmund', '多特蒙德': 'Borussia Dortmund', '勒沃库森': 'Bayer Leverkusen',
            '莱比锡': 'RB Leipzig', '国米': 'Inter Milan', 'AC米兰': 'AC Milan', '米兰': 'AC Milan',
            '巴黎': 'Paris Saint-Germain', '巴黎圣日耳曼': 'Paris Saint-Germain', '大巴黎': 'Paris Saint-Germain',
            '马竞': 'Atletico Madrid', '马德里竞技': 'Atletico Madrid', '尤文': 'Juventus', '尤文图斯': 'Juventus',
            '那不勒斯': 'Napoli', '罗马': 'Roma', '拉齐奥': 'Lazio', '亚特兰大': 'Atalanta', '佛罗伦萨': 'Fiorentina',
            '里昂': 'Lyon', '摩纳哥': 'Monaco', '马赛': 'Marseille',
            '纽卡斯尔': 'Newcastle', '维拉': 'Aston Villa', '阿斯顿维拉': 'Aston Villa', '西汉姆': 'West Ham',
            '埃弗顿': 'Everton', '莱斯特城': 'Leicester', '塞维利亚': 'Sevilla', '瓦伦西亚': 'Valencia',
